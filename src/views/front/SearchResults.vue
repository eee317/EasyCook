          ...
          <div class="card border-0 h-100 bg-bright-green p-4 py-lg-6 py-lg-7" style="">
            <div class="row g-0 flex-nowrap align-items-center align-items-lg-start">
              <div class="col-md-4 col-3 line-lg-before">
                  <a href="javascript:;" @click="goTheRecipePage(recipe.id)" class=" text-reset text-decoration-none">
                  <img
                      class="w-100
                        w-sm-75 w-lg-75
                        img-fluid
                    ...
                    />
                    <button @click="goTheRecipePage(recipe.id)" class="text-card-green-300 d-lg-none btn d-inline-block text-center">查看食譜</button>
                    </a>
            ...
            <a @click="goTheRecipePage(recipe.id)" class="btn-search-more btn text-card-green-300 d-none d-lg-inline-block position-absolute">查看食譜</a>
          </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    goTheRecipePage (id) {
      this.$router.push(`/recipesContent/${id}`)
    }
    // getRecipes () {
