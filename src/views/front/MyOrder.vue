<template>
  ...
  <div class="myOrder-equipment-bg py-10 mt-15">
    <div class="container">
      <div class="row">
        <h2 class="h1 text-dark-green text-lg-start">所需的廚房用品</h2>
        <div class="">
          <table class="w-100 my-5 table ">
            ...
            <tbody class="text-dark-green">
              ...
              v-for="order in orders" :key="order.id+'order'">
                ...
                <td class="py-4 d-none d-lg-table-cell  border-card-green-300"><img width="180" class="img-fluid rounded-2 border border-card-green-300 border-2 rounded-2"
  ...
  <div class="container">
    <div class="row">
      <div class="text-start">
        <h2 class="text-dark-green mt-15 mb-5">我的冰箱還有食材</h2>
        <p class="text-dark-green m-0 pb-5">發現前幾天煮完飯還有剩餘的食材，請先設定冰箱有哪些食材，幫您計算還需要購買多少食材。</p>
      </div>
      <div>
        <div class="card border-0 bg-bright-green pb-5">
          <div class="card-body p-0">
            <div class="border-bottom border-1 d-flex justify-content-between align-items-center py-3 px-5">
              <h5 class="card-title text-own-brown text-start m-0">我的冰箱</h5>
            ...
            <div class="d-flex justify-content-between align-items-center py-3 px-5 text-own-brown">
              <h6 class="color-own-brown-lighten">食材名稱</h6>
              <h6 class="color-own-brown-lighten">數量</h6>
            </div>
            <div class="text-own-brown px-5 d-flex">
              <input class="form-control tl-bl-radius" type="text" placeholder="Default input" aria-label="default input example">
              <input class="form-control tr-br-radius tl-bl-radius text-end" type="text" placeholder="Default input" aria-label="default input example">
            </div>
          </div>
        </div>
      </div>
